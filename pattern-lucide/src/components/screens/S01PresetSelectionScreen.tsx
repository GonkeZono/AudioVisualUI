...
import { DoorOpen, LayoutGrid, ArrowLeft, Check, Sparkles } from "lucide-react";
    ...
    <div className="h-full w-full bg-slate-900 flex flex-col justify-between p-6 select-none overflow-hidden">
      ...
      <div className="flex items-center justify-between">
        ...
        <h2 className="text-xl font-bold text-slate-100 flex items-center gap-2">
          ...
          <span className="text-sm font-normal text-slate-400">/ 運用プリセット選択</span>
        </h2>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <span className="text-xs text-slate-400">Main Hall Mode</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <span className="text-xs text-slate-400">Mid Hall Mode</span>
              </div>
            </div>
