...
export default function AppIcon({
  ...
  if (activeTheme === "tabler") {
    switch (iconType) {
      ...
      case "cast":
        return <IconCast className={className} />;
      ...
      case "volumex":
      case "mute":
        return <IconVolumeOff className={className} />;
      ...
      case "power":
        return <IconPower className={className} />;

      case "poweroff":
        return <IconPower className={className} strokeWidth={2.5} />;

      case "facility":
      case "layers":
      case "cable":
      case "disc":
        return <IconGridDots className={className} />;

      case "sliders":
      case "settings":
        return <IconSettings2 className={className} />;
      ...
      case "pause":
        return <IconPause className={className} />;
      ...
      case "building":
      case "building2":
        return <IconBuildingSkyscraper className={className} />;
      ...
      case "dooropen":
      case "door":
        return <IconDoor className={className} />;
      ...
      case "hourglass":
        return <IconHourglass className={className} />;

      case "share2":
      case "share":
        return <IconShare2 className={className} />;
      ...
      case "fan":
        return <IconFan className={className} />;
